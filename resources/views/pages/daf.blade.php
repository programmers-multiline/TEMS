...
@section('content-title', 'List of DAF')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.approveBtn', function() {
                ...
                const prevCount = parseInt($("#dafCount").text());
