<div class="modal fade" id="uploadPic" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-popin" role="document">
        <div class="modal-content">
            ...
            <form id="formRequest" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" id="routeUrl" value="{{route('upload_tool_picture')}}">

                <div class="block block-rounded shadow-none mb-0">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Upload Picture with Serial#</h3>
                    ...
                    <div class="block-content fs-sm">
                        <div class="block block-rounded">
                            <div class="block-content">
                                <input type="file" class="picUpload" multiple
