                ...
                <div style="width: 1000px; min-height: 1056px;" class="containerPrint containerPrintDaf px-2 mx-auto">
                    ...
                    <div class="borders" style="display: flex; border-top: 2px solid black">
                        ...
                        <div style="border-right: 1px solid black; padding-left: 3px; width: 100%">
                            ...
                            <p style="text-align: center; padding-left: 10px;margin-top: 5px;margin-bottom: 5px;"><span class="fw-bold text-secondary" style="font-size: 13px;">No Signature Required as agreed to the System</span></p>
                        </div>
                        <div style=" padding-left: 3px; width: 50%">
                            <h6 style="">Date</h6>
                            <p style="padding-left: 10px;margin-top: 5px;margin-bottom: 5px;">
